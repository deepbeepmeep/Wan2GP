# Model Implementation Drift vs Upstream
...
## Affected Files
- `Wan2GP/models/_settings.json`
- `Wan2GP/models/flux/flux_handler.py`
- `Wan2GP/models/longcat/longcat_main.py`
- `Wan2GP/models/longcat/modules/attention.py`
- `Wan2GP/models/longcat/modules/avatar/attention.py`
- `Wan2GP/models/ltx_video/ltxv_handler.py`
- `Wan2GP/models/qwen/qwen_handler.py`
- `Wan2GP/models/z_image/pipeline_z_image.py`
- `Wan2GP/models/z_image/z_image_main.py`
