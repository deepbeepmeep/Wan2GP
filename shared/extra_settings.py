...
_add_setting("attention_sparsity", _model_setting_label("attention_sparsity", "Attention Sparsity"), "number", min=_model_setting_bound("attention_sparsity", "start", 0.0), max=_model_setting_bound("attention_sparsity", "end", 4.0), step=_model_setting_bound("attention_sparsity", "inc", 0.05), visible=_show_if(lambda model_def: any(mode.get("supports_sparsity", False) for mode in model_def.get("custom_attention_modes", {}).values())))
...
_add_setting("planner_temperature", "Planner Temperature (0 = greedy)", "number", min=0.0, max=1.5, step=0.01, visible=_show_if_flag("planner"))
_add_setting("planner_top_p", "Planner Top-p", "number", min=0.0, max=1.0, step=0.01, visible=_show_if_flag("planner"))
_add_setting("planner_top_k", "Planner Top-k (0 = disabled)", "integer", min=0, max=100, step=1, visible=_show_if_flag("planner"))
_add_setting("planner_repetition_penalty", "Planner Repetition Penalty (1 = disabled)", "number", min=1.0, max=1.5, step=0.001, visible=_show_if_flag("planner"))
_add_setting("planner_penalty_window", "Planner Repetition Penalty Window (tokens)", "integer", min=1, max=100, step=1, visible=_show_if_flag("planner"))
_add_setting("planner_min_tokens", "Planner Minimum Tokens", "integer", min=0, max=2048, step=1, visible=_show_if_flag("planner"))
_add_setting("planner_max_tokens", "Planner Maximum Tokens", "integer", min=256, max=16384, step=256, visible=_show_if_flag("planner"))
