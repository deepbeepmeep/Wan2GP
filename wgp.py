...
def load_models(model_type, override_profile = -1, output_type="video", download_progress_callback=None, status_callback=None, config_id = None, **model_kwargs):
