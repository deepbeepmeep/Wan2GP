# Plugin Integration Drift vs Upstream
...
## Affected Files
- `Wan2GP/plugins.json`
- `Wan2GP/plugins/wan2gp-configuration/plugin.py`
- `Wan2GP/plugins/wan2gp-guides/plugin.py`
- `Wan2GP/plugins/wan2gp-models-manager/plugin.py`
- `Wan2GP/plugins/wan2gp-motion-designer/assets/app.js`
- `Wan2GP/plugins/wan2gp-sample/plugin.py`
