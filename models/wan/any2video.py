        ...
        **bbargs
        ...
        for i, t in enumerate(tqdm(timesteps)):
            ...
            if self_refiner_handler:
                latents, sample_scheduler = self_refiner_handler.step(i, latents, noise_pred, t, timesteps, target_shape, seed_g, sample_scheduler, scheduler_kwargs, denoise_with_cfg_fn, phase_index=(2 if guidance_switch2_done else 1 if guidance_switch_done else 0) if guide_phases > 1 else 0)
