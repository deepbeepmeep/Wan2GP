...
def get_model_config(model_name):
    with open(MAIN_MODELS_DIR + "/DFN5B-CLIP-ViT-H-14-378/open_clip_config.json", 'r', encoding='utf-8') as f:
    ...
    def __init__(
        ...
        *,
        ...
        if enable_conditions:
            ...
            self.clip_model = create_model('DFN5B-CLIP-ViT-H-14-378', pretrained=MAIN_MODELS_DIR + '/DFN5B-CLIP-ViT-H-14-378/open_clip_pytorch_model.bin',  force_preprocess_cfg= override_preprocess)
