...
class ModelConfig:
    ...
    mode: str
    synchformer_ckpt: Path = Path(MAIN_MODELS_DIR + '/mmaudio/synchformer_state_dict.pth')
...
large_44k_v2 = ModelConfig(model_name='large_44k_v2',
                           model_path=Path(MAIN_MODELS_DIR + '/mmaudio/mmaudio_large_44k_v2.pth'),
                           vae_path=Path(MAIN_MODELS_DIR + '/mmaudio/v1-44.pth'),
                           bigvgan_16k_path=None,
                           mode='44k')
