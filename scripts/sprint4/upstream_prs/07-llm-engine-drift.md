...
## Affected Files
- `Wan2GP/shared/llm_engines/cudagraph_kit.py`
- `Wan2GP/shared/llm_engines/nanovllm/engine/block_manager.py`
- `Wan2GP/shared/llm_engines/nanovllm/engine/llm_engine.py`
- `Wan2GP/shared/llm_engines/nanovllm/engine/model_runner.py`
- `Wan2GP/shared/llm_engines/nanovllm/layers/attention.py`
- `Wan2GP/shared/llm_engines/nanovllm/models/qwen3_5.py`
- `Wan2GP/shared/llm_engines/nanovllm/utils/context.py`
- `Wan2GP/shared/llm_engines/nanovllm/vllm_support.py`
