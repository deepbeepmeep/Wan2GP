...
| Reuse a voice | Say the following with the same voice: \"Thank you for joining us today.\" | Yes, a voice reference |
...
| Change emotion | Make the speech sound happy while preserving the words and speaker's voice. | Yes |
...
- Clone: `Say the following with the same voice: "Thank you for joining us."`
- Edit: `Replace "tomorrow" with "next week", keeping the same speaker and tone.`
- Emotion: `Make the speech sound happy while preserving the words and voice.`
