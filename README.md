<p align="center">
  <a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=wan2gp">
    <img src="docs/atlas-cloud-logo.png" alt="Atlas Cloud" width="200">
  </a>
</p>

> 🎁 **[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=wan2gp)** — No GPU? No problem. Atlas Cloud provides Wan2, Kling, Seedance, and Veo video generation models via cloud API, with zero local GPU requirements. 59 frontier models total. [View all models](https://www.atlascloud.ai/models)
